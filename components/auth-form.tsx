    ...
    <main className="min-h-screen bg-[#050506] text-white">
      ...
      <div className="relative z-10 grid min-h-screen lg:grid-cols-[1.1fr_.9fr]">
        <section className="hidden border-r border-white/5 lg:flex lg:flex-col lg:justify-between lg:p-12 xl:p-16">
          ...
          <div className="max-w-xl"><p className="text-sm font-medium text-zinc-500">YOUR AI, ALL IN ONE PLACE</p><h1 className="mt-5 text-5xl font-semibold leading-[1.05] tracking-[-.045em]">One conversation for the things that matter.</h1><p className="mt-6 max-w-lg text-lg leading-8 text-zinc-400">Think, create, research and get things done with ZenixMind.</p></div>
        ...
        <section className="flex min-h-screen items-center justify-center px-5 py-10 sm:px-8">
          <div className="w-full max-w-md">
            ...
            <div className="rounded-[30px] border border-white/[.08] bg-[#0a0a0c]/90 p-6 shadow-[0_30px_100px_rgba(0,0,0,.45)] backdrop-blur-xl sm:p-8">
