      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-[270px] shrink-0 border-r border-white/5 bg-[#08080b] p-4 lg:flex lg:flex-col">
          ...
          <nav className="mt-6 space-y-1 text-sm">
            <Link href="/owner" className="block rounded-xl bg-black/[.45] px-3 py-3 text-white">Overview</Link>
            <Link href="/dashboard" className="block rounded-xl px-3 py-3 text-zinc-500 hover:bg-black/[.45] hover:text-white">User dashboard</Link>
            <Link href="/assistant" className="block rounded-xl px-3 py-3 text-zinc-500 hover:bg-black/[.45] hover:text-white">Assistant</Link>
          </nav>
        ...
        <section className="min-w-0 flex-1">
          <header className="flex min-h-[68px] items-center justify-between border-b border-white/5 px-5 sm:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="grid h-9 w-9 place-items-center rounded-full bg-black/50 text-xs font-medium text-zinc-300">D</span>
            </div>
          </header>
          ...
          <div className="mx-auto max-w-6xl px-5 py-9 sm:px-8 sm:py-12">
            ...
            <section className="mt-10">
              ...
              <div className="mt-5 grid gap-3 md:grid-cols-2">
                {sections.map(([title, body, status]) => (
                  <div key={title} className="rounded-2xl border border-white/8 bg-black/[.45] p-6">
            ...
            <section className="mt-10 rounded-2xl border border-white/8 bg-black/[.45] p-6">
